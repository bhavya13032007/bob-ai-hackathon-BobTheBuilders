...
const LandingPage = () => {
  ...
  const stories = [
    {
      ...
      quote: "Being from a tier-3 college, I had no corporate network. CareerSetu matched me with a government PSU right in my zone. The stipend directly credited via DBT changed my family's financial situation!",
    ...
    },
    {
      ...
      quote: "The mentor assigned through CareerSetu helped me practice my interview questions in Hindi. I felt confident for the first time in front of corporate recruiters.",
  ...
  const handleListenGuide = () => {
    ...
    const messageText = lang === 'hi'
      ? "कैरियरसेतु एआई में आपका स्वागत है। पीएम इंटर्नशिप योजना के तहत आप 3 आसान चरणों में सबसे बेहतरीन इंटर्नशिप पा सकते हैं। पहला, अपना बायोडाटा अपलोड करें या शिक्षा चुनें। दूसरा, हमारा एआई आपके कौशल और जिले के अनुसार निकटतम कंपनियों को ढूंढेगा। तीसरा, बिना किसी शुल्क के एक क्लिक में आवेदन करें। शुरू करने के लिए फाइंड माय मैच पर क्लिक करें।"
      : "Welcome to CareerSetu AI, the PM Internship Scheme recommendation platform. You can find the best internship in 3 simple steps: First, upload your resume or select your education level. Second, our AI will match your skills and location with verified companies like Tata Motors and Infosys. Third, apply in one click with zero application fee. Click on Find My Match to begin.";
      ...
      <div className="bg-gray-50/80 py-20 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-10 relative">
            {/* Step 1 */}
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 text-center relative z-10 hover:shadow-md transition-all hover:-translate-y-1">
