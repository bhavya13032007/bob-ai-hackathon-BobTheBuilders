...
import { User, Mail, Phone, MapPin, GraduationCap, X, CheckCircle, Plus, Trash2, Sparkles, Building2, Zap } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100 flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <div className="text-[11px] font-bold text-gray-500 mb-1.5 flex items-center"><Zap size={14} className="mr-1 text-yellow-500" /> Suggested Skills:</div>
