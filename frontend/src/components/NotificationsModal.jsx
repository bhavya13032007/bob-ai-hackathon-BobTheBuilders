...
import { Bell, CheckCircle, Clock, ShieldCheck, AlertCircle, X, Send, Sliders, Smartphone, MessageSquare, Zap, Check, Eye, Target } from 'lucide-react';
            ...
            <>
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                <span className="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-2 flex items-center">
                  <Zap size={14} className="mr-1 text-yellow-500" /> Test Live Notifications
                </span>
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <span className="flex items-center"><Target size={14} className="mr-1" /> + New Match</span>
                  </button>
                  <button
                    onClick={() => handleSimulate('cert_verified')}
                    className="text-xs bg-gray-50 hover:bg-gray-100 border border-gray-200 p-2 rounded-xl text-gray-700 font-semibold transition-colors text-left"
                  >
                    <span className="flex items-center"><Check size={14} className="mr-1" /> + Cert Verified</span>
                  </button>
                  <button
                    onClick={() => handleSimulate('app_viewed')}
                    className="text-xs bg-gray-50 hover:bg-gray-100 border border-gray-200 p-2 rounded-xl text-gray-700 font-semibold transition-colors text-left"
                  >
                    <span className="flex items-center"><Eye size={14} className="mr-1" /> + App Viewed</span>
                  </button>
                  <button
                    onClick={() => handleSimulate('deadline_alert')}
                    className="text-xs bg-gray-50 hover:bg-gray-100 border border-gray-200 p-2 rounded-xl text-gray-700 font-semibold transition-colors text-left"
                  >
                    <span className="flex items-center"><Clock size={14} className="mr-1" /> + Deadline Alert</span>
                  </button>
                </div>
              </div>
            </>
